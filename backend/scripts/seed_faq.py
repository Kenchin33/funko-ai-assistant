...
FAQ_SEED_DATA = [
    ...
    },
    {
        ...
        "keywords": "передзамовлення, умови, передоплата",
        "button_label": "Детальніше",
        "button_url": "/preorder",
        "priority": 88,
        "is_active": True,
    },
    {
        ...
        "keywords": "передзамовлення, скасування, передоплата",
        "button_label": "Детальніше",
        "button_url": "/preorder",
        "priority": 87,
        "is_active": True,
    },
    {
        ...
        "answer": "Ви завжди можете написати нам на пошту або в одну з наших соціальних мереж. Посилання на наші соціальні мережі є на сторінці «Контакти».\nНаша пошта: funkohunter0@gmail.com",
